...
predictions = {
        ...
        'DIEE🎲':         [ 9,25, 4,24,19,10, 5,14,17,22, 6,11,21,15, 7, 1,23,12,18, 2, 8,20,16, 3,13],
        'ALEX👽':         [18,25,22,24,16,13,19, 9,11, 4, 3, 8, 6,20, 1, 7,12,15,14,10,23, 5,17, 2,21],
        'ALXP🪅':         [24,16,14,10, 1,19, 2,12,22,11,21, 5,25,13,20, 3, 8,23, 9,17,15, 6, 7,18, 4],
        ...
        # 'ALSH🛼':         [21,23,12,13,11,14, 9,10, 3, 7,19,18,15,16,17,15,20,16,14,10, 3, 1,13,11, 4],
